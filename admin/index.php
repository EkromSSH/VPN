...
.box{background:#161b22;padding:32px;border-radius:16px;border:1px solid #30363d;width:100%;max-width:360px;}
h1{color:#58a6ff;text-align:center;margin-bottom:4px;font-size:22px;}
p{color:#8b949e;text-align:center;margin-bottom:20px;}
input{width:100%;padding:12px 16px;margin-bottom:12px;background:#0d1117;border:1px solid #30363d;border-radius:8px;color:#c9d1d9;font-size:16px;}
...
.nav a:hover,.nav a.act{background:#1f6feb20;color:#58a6ff;}
.nav a.act{font-weight:600;}
...
th{color:#8b949e;font-size:11px;padding:7px 8px;text-align:left;border-bottom:1px solid #21262d;}
td{padding:7px 8px;border-bottom:1px solid #21262d;font-size:13px;}
.msg{padding:10px 12px;border-radius:8px;margin-bottom:10px;background:#0d1117;border:1px solid #30363d;font-size:13px;}
@media(min-width:600px){.bar{padding:12px 24px;}.bar .t{font-size:18px;}.nav a{font-size:13px;padding:6px 12px;}.m{padding:20px 24px;}.gr{grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:12px;}}
</style></head><body>
