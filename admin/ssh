...
echo -e "\033[1;93m      \033[42mเมนูจัดการ SSH\033[0m\033[1;93m        \033[0m"
echo -e "\033[1;93m=============================\033[0m"
echo -e "  ${grenbo}1.${NC} \033[0;36mสร้างบัญชี SSH OVPN\033[0m"
echo -e "  ${grenbo}2.${NC} \033[0;36mลบบัญชี SSH OVPN\033[0m"
echo -e "  ${grenbo}3.${NC} \033[0;36mต่ออายุบัญชี SSH OVPN\033[0m"
echo -e "  ${grenbo}4.${NC} \033[0;36mตรวจสอบ SSH OVPN\033[0m"
echo -e "  ${grenbo}5.${NC} \033[0;36mเปลี่ยนพอร์ต SSH WS\033[0m"
echo -e "  ${grenbo}6.${NC} \033[0;36mติดตั้งเว็บ Panel\033[0m"
echo -e "  ${grenbo}7.${NC} \033[0;36mอัปเดตระบบ\033[0m"
echo -e "\033[1;93m=============================\033[0m"
